...
"Français": { 
  translation: {
    ...
    "Minimum recharge amount": "Montant de recharge minimum",
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Votre adresse de recharge ne changera pas fréquemment et vous pouvez recharger à plusieurs reprises",
    "If there is any change, we will try our best to notify you through website announcement or email": "En cas de changement, nous ferons de notre mieux pour vous informer via une annonce sur le site Web ou par e-mail",
...
"Deutsch": {
  translation: {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Ihre Aufladeadresse ändert sich nicht häufig und Sie können wiederholt aufladen",
    "If there is any change, we will try our best to notify you through website announcement or email": "Falls es Änderungen gibt, werden wir Sie nach besten Kräften über Website-Ankündigungen oder E-Mail benachrichtigen",
...
"Italiano": {
  translation: {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Il tuo indirizzo di ricarica non cambierà frequentemente e puoi ricaricare ripetutamente",
    "If there is any change, we will try our best to notify you through website announcement or email": "In caso di modifiche, faremo del nostro meglio per informarti tramite annunci sul sito web o email",
...
"Crypto.com intro paragraph 3":
  "Crypto.com은 800개 이상의 고품질 암호화폐와 1000개 이상의 거래 페어를 지원하는 종합 거래 플랫폼입니다. 현물, 레버리지, OTC, 선물, 신용카드 구매 등 다양한 거래 서비스를 제공하며 가장 안전하고 효율적이며 전문적인 디지털 자산 투자 서비스를 제공합니다.",
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "귀하의 충전 주소는 자주 변경되지 않으며 반복적으로 충전할 수 있습니다",
    "If there is any change, we will try our best to notify you through website announcement or email": "변경 사항이 있을 경우 웹사이트 공지 또는 이메일을 통해 최대한 알려드리겠습니다",
...
"Enter withdrawal quantity": "출금 수량을 입력하세요",
  ...
  "日本語": {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "お客様の入金アドレスは頻繁に変更されることはなく、繰り返し入金できます",
    "If there is any change, we will try our best to notify you through website announcement or email": "変更がある場合は、ウェブサイトの告知またはメールでお知らせします",
...
"中文繁体": {
  translation: {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "您的充值地址不會頻繁變更，可多次充值",
    "If there is any change, we will try our best to notify you through website announcement or email": "如有任何變更，我們將盡力通過網站公告或郵件通知您",
  ...
  "中文简体": {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "您的充值地址不会频繁变更，可多次充值",
    "If there is any change, we will try our best to notify you through website announcement or email": "如有任何变更，我们将尽力通过网站公告或邮件通知您",
...
"ภาษาไทย": {
  translation: {
    ...
    "Minimum recharge amount": "จำนวนเงินเติมขั้นต่ำ",
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "ที่อยู่การเติมเงินของคุณจะไม่เปลี่ยนแปลงบ่อย และคุณสามารถเติมเงินซ้ำได้",
    "If there is any change, we will try our best to notify you through website announcement or email": "หากมีการเปลี่ยนแปลงใดๆ เราจะแจ้งให้คุณทราบผ่านประกาศบนเว็บไซต์หรืออีเมล",
  ...
  "Tiếng Việt": {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Địa chỉ nạp tiền của bạn sẽ không thay đổi thường xuyên và bạn có thể nạp tiền nhiều lần",
    "If there is any change, we will try our best to notify you through website announcement or email": "Nếu có bất kỳ thay đổi nào, chúng tôi sẽ cố gắng thông báo cho bạn qua thông báo trên trang web hoặc email",
...
"español": {
  translation: {
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Su dirección de recarga no cambiará con frecuencia y puede recargar repetidamente",
    "If there is any change, we will try our best to notify you through website announcement or email": "Si hay algún cambio, haremos todo lo posible para notificarle a través de anuncios en el sitio web o por correo electrónico",
...
"Türkçe": {
  translation: {
    ...
    "Minimum recharge amount": "Minimum yükleme miktarı",
    ...
    "Your recharge address will not change frequently, and you can recharge repeatedly": "Yükleme adresiniz sık değişmeyecek ve tekrar tekrar yükleme yapabilirsiniz",
    "If there is any change, we will try our best to notify you through website announcement or email": "Herhangi bir değişiklik olursa, web sitesi duyurusu veya e-posta yoluyla size bildirmek için elimizden geleni yapacağız",
